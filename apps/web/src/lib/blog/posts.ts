...
export const POSTS: BlogPost[] = [
  {
    ...
    description:
      'LED 사이니지(전광판) 견적은 사진 3장만 있으면 30분 내로 범위 견적이 가능합니다. 우강테크가 표준화한 견적 절차와 체크리스트를 정리합니다.',
    category: '도입 가이드',
    ...
    tldr: [
      ...
      '범위 견적은 30분 내, 확정 견적은 현장 실사(1~3일) 후.',
      '구독형 CMS는 월 29,000원~ 부터 시작.',
    ],
    faq: [
      {
...
우강테크는 이 절차를 사진 3장 + 기본 정보 입력만으로 **30분 내**에 끝낼 수 있도록 표준화했습니다.
...
| 2. 범위 견적 발송 | 30분 | 카카오 알림톡 또는 문자로 예상 범위 + 추천 SKU 전송 |
...
| 6. CMS 구독 시작 | 즉시 | VNNOX 계정 발급 + 첫 콘텐츠 업로드 |
...
- 실내 소형 (1m² 미만): **₩1,600,000 ~ ₩2,800,000** + CMS 월 29,000원~
- 실내 중형 (1~3m²): **₩2,800,000 ~ ₩4,700,000** + CMS 월 49,000원
- 옥외 중형 (3~5m²): **₩4,700,000 ~ ₩8,500,000** + CMS 월 49,000원~
...
견적이 필요하시면 **사진 3장과 기본 정보**만 [견적 페이지](/quote)에 입력하세요. 30분 내로 카카오 알림톡 또는 문자로 범위 견적을 받아보실 수 있습니다.
