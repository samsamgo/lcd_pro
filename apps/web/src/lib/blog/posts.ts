...
export const POSTS: BlogPost[] = [
  {
    ...
    tldr: [
      ...
      '설치 시 초기 콘텐츠 세팅과 교체 방법 교육까지 지원한다.',
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          '설치 시점에 초기 콘텐츠를 세팅해 드리고, 메뉴·홍보 화면을 직접 교체하는 방법을 1:1로 교육합니다. 운영 중에도 콘텐츠 제작을 지원하며, 컨트롤러는 원격 운영이 가능한 NovaStar 표준을 사용합니다.',
      },
      {
...
| 6. 운영 시작 | 즉시 | 초기 콘텐츠 세팅 + 교체 방법 1:1 교육 |
...
> 설치비 기준 예상 범위이며 VAT 별도입니다. 최종 금액은 현장 실측 후 확정됩니다.
