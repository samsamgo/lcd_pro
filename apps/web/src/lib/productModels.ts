...
export const PRODUCT_MODELS: ProductModel[] = [
  /* ───────────────────────── 실내 ───────────────────────── */
  {
    ...
    form: 'module',
    name: '초미세 COB 모듈',
    tagline: '한 걸음 앞에서 보는 화면. 화소 간격 1mm 아래까지 내려갑니다.',
  ...
  },
  {
    ...
    form: 'module',
    name: '플립칩 COB 모듈',
    tagline: '표면이 하나로 덮인 COB. 사람이 지나다니며 스치는 자리에 씁니다.',
  ...
  },
  {
    ...
    form: 'module',
    name: '실내 표준 모듈',
    tagline: '민원실·로비·회의실에 가장 많이 들어가는 실내 표준형. 여덟 가지 간격.',
  ...
  },
  {
    ...
    form: 'module',
    envLabel: '실내 · 실외',
    name: '실내·실외 겸용 고주사 모듈',
    tagline: '리프레시 7,600Hz. 카메라로 찍히는 자리, 방송 송출이 걸린 자리에 씁니다.',
    images: [{ src: `${IMG}/prime-1.png`, alt: '고주사 모듈의 표시면과 뒷면 기판' }],
    pitches: ['P1.25', 'P1.53', 'P1.86', 'P2', 'P2.5', 'P2.5 실외', 'P3.076 실외', 'P4 실외', 'P5 실외'],
  ...
  },
  {
    ...
    form: 'module',
    name: '곡면·연성 모듈',
    tagline: '기둥·아치처럼 평면이 아닌 자리에 붙입니다. 바닥이 고무라 휘어집니다.',
  ...
  },
  {
    ...
    form: 'cabinet',
    name: '초박형 실내 캐비닛',
    tagline: '두께 29.8mm. 벽에서 튀어나오지 않아야 하는 실내 자리에 씁니다.',
  ...
  },
  {
    ...
    form: 'cabinet',
    name: '전면 유지보수 실내 캐비닛',
    tagline: '앞에서 열어 고칩니다. 벽에 붙여 시공해 뒤로 들어갈 자리가 없을 때.',
    ...
    specRows: [
      ...
      { label: '캐비닛 해상도 (W×H)', values: ['512×384', '416×312', '348×261', '344×228', '320×240', '256×192', '208×156', '160×120'] },
  ...
  },
  {
    ...
    form: 'cabinet',
    name: '실내 보급형 캐비닛',
    tagline: '전면·후면 어느 쪽에서도 고칠 수 있는 실내 기본형. 예산이 먼저인 자리에.',
  ...
  /* ───────────────────────── 실외 ───────────────────────── */
  {
    ...
    form: 'module',
    name: '실외 표준 모듈',
    tagline: '정문·도로변·게시대. 멀리서 읽는 화면일수록 간격을 넓게 잡습니다.',
  ...
  },
  {
    ...
    form: 'cabinet',
    name: '실외 IP65 캐비닛',
    tagline: '960×960 한 장 단위로 화면을 키웁니다. 전면 IP65로 비를 맞는 자리에.',
    ...
    specRows: [
      ...
      { label: '캐비닛 해상도 (W×H)', values: ['256×256', '208×208', '240×240', '192×192', '144×144', '120×120', '96×96'] },
  ...
  /* ───────────────────────── 렌탈 · 행사 ───────────────────────── */
  {
    ...
    envLabel: '렌탈 (실내 · 실외)',
    name: '렌탈 모듈',
    tagline: '250×250 정사각 모듈. 행사장에서 세웠다 접는 화면의 기본 단위입니다.',
  ...
  },
  {
    ...
    envLabel: '렌탈 (실내 · 실외)',
    name: '렌탈 캐비닛',
    tagline: '손잡이와 잠금장치가 달린 조립형. 곡면으로도 이어 붙습니다.',
