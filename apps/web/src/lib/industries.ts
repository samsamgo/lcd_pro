...
export const INDUSTRIES: Industry[] = [
  {
    ...
    description:
      '창구 대기번호, 부서·층별 안내, 시정 공지를 한 화면에서 돌립니다. 민원실은 사람이 코앞에서 보는 자리라 화소가 촘촘하지 않으면 작은 글자가 뭉칩니다. 그래서 실내 정밀형으로 가고, 대기 공간이 얼마나 되는지 보고 규격을 정합니다.',
    pains: [
  ...
  },
  {
    ...
    description:
      '급식표와 행사 안내, 귀가 시간, 강당 행사 화면을 한 곳에서 돌립니다. 다만 교내 복도에서 보는 화면과 강당 뒷줄에서 보는 화면, 운동장 건너에서 보는 화면은 필요한 규격이 다릅니다. 그래서 위치별로 나눠서 봅니다.',
    pains: [
  ...
  },
  {
    ...
    description:
      '건물 외벽이나 도로변에 거는 대형 화면입니다. 밖에 걸면 밝기와 방수 등급이 먼저고, 벽이 무게를 견디는지, 옥외광고물 신고 대상인지까지 같이 봐야 합니다.',
    pains: [
