...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: '법인 설립은 2026년입니다. 그래서 유사 납품실적 3건 같은 요건이 붙는 일반 경쟁입찰에는 아직 들어가지 못합니다. 반대로 2천만원 미만 수의계약은 실적 요건 자체가 없어 지금 바로 계약이 됩니다. 담당자가 실제로 걱정하시는 것은 회사 나이가 아니라 설치하고 나서 연락이 되느냐일 겁니다. 그건 하자보증보험 증서와 계약서에 적힌 보증 기간으로 담보됩니다. 계약금액의 10%를 하자보증으로 잡고 기간을 3년으로 두면, 저희가 없어져도 기관은 보험으로 회수하십니다. 실적 대신 서류로 확인하실 수 있게 규격서·인증 서류·보증 조건을 계약 전에 전부 드립니다.',
  },
  {
    cat: '예산·계약',
    q: '견적을 요청하면 언제 연락이 오나요?',
    a: '영업일 기준 1일 안에 남겨주신 연락처로 연락드립니다. 첫 통화에서는 설치 위치와 보는 거리, 전기를 어디서 끌어올 수 있는지 정도만 확인합니다. 이 통화만으로 개략 범위가 잡히면 규격서를 먼저 보내드리고, 현장을 봐야 하는 조건이면 실측 일정을 그 자리에서 잡습니다. 사진을 함께 보내주시면 통화 시간이 짧아집니다.',
  },
  {
    cat: '예산·계약',
  ...
  },
  {
    ...
    a: 'LED는 모듈 단위로 교체할 수 있어 부분 고장 시 화면 전체를 해체하지 않습니다. 접수 → 원격 확인 → 방문 판정 → 해당 모듈 교체 → 결과 보고 순으로 진행하고, 처리 내역은 문서로 드리니 필요하실 때 그대로 쓰시면 됩니다. 하드웨어 무상보증은 스탠다드 1년, 프리미엄 2년이며 프리미엄은 예비부품 보유가 포함됩니다. 이건 제품 보증이고, 계약상 하자보증은 별개입니다. 공공계약은 보통 계약금액의 10%를 하자보증으로 잡고 기간은 3년입니다. 예산 짜실 때 이 항목이 빠져 있으면 계약 단계에서 다시 조정해야 합니다.',
  },
  {
    cat: '사후관리',
