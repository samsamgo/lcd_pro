...
const STEPS: Step[] = [
  {
    ...
    title: '현장 실측 · 기본설계',
    body:
      '모든 도면과 견적은 이 단계의 숫자에서 나옵니다. 얼마나 떨어져서 보는지, 바닥에서 몇 미터인지, 붙일 구조물이 뭔지, 전기를 어디서 끌어오는지를 직접 가서 잽니다. 사진만 보고 규격을 정하지 않습니다.',
  ...
  },
  {
    ...
    title: '규격 확정 · 제작',
    body:
      '불량은 공장에서 걸러냅니다. 실측값으로 화소 간격과 화면 크기, 밝기, 방수 등급을 확정해 캐비닛을 조립하고, 화면 전체를 켜서 색과 밝기가 고른지 봅니다. 걸리면 현장에 내보내지 않습니다.',
