 ...
 *   02 규격서는 실제 산출물 목록(02장 points)에 있다.
...
const PRINCIPLES: Principle[] = [
  ...
  {
    no: '02',
    line: '규격서가 견적서보다 먼저입니다.',
    body: '무엇을 어떤 기준으로 만들지 적은 규격서를 먼저 드립니다. 금액은 그다음에 나옵니다.',
    range: [0.33, 0.37, 0.62, 0.66],
  },
  {
    no: '03',
    line: '설치는 하루, 운영은 10년입니다.',
    body: '다는 데는 하루면 끝납니다. 그 뒤로는 원격으로 보고, 가서 갈고, 결과를 문서로 남깁니다.',
