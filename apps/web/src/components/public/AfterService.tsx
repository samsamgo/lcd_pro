...
const STEPS: { n: string; title: string; desc: string; who: string }[] = [
  {
    n: '01',
    title: '접수',
    desc: '전화든 접수 폼이든 편한 쪽으로 하십시오. 정해진 양식은 없습니다. 증상 한 줄이면 시작됩니다.',
    who: '담당자 → 우강테크',
  },
  {
    n: '02',
    title: '원격 확인',
    desc: '전원 문제인지, 신호 문제인지, 모듈 문제인지부터 가릅니다. 차단기나 설정 때문이었던 건은 여기서 끝나기도 합니다.',
    who: '우강테크',
  },
  {
    n: '03',
    title: '방문 판정',
    desc: '출발하기 전에 무엇이 문제고 얼마나 걸리는지 먼저 알려드립니다.',
    who: '우강테크',
  },
  {
    n: '04',
    title: '부품 교체',
    desc: '고장 난 모듈만 앞에서 빼서 갈아 끼웁니다. 화면 전체를 내릴 일은 거의 없습니다. 앞으로 접근이 안 되는 자리면 고소작업차가 필요한데, 그 경우는 미리 말씀드립니다.',
    who: '우강테크',
  },
  {
    n: '05',
