...
const CHAPTERS: Chapter[] = [
  {
    ...
    title: '직접 설계합니다',
    body:
      '어떤 모듈을 쓸지, 어떤 프레임에 올릴지, 어떤 검사를 거칠지까지 10년의 경험을 바탕으로 직접 정합니다. 남이 만든 걸 받아다 파는 방식이 아닙니다.',
  ...
  },
  {
    ...
    body:
      '고장 났을 때가 더 중요합니다. 다는 데는 하루면 끝나지만 쓰는 건 몇 년이기 때문입니다. 원격으로 먼저 보고, 가서 점검하고, 부품 갈고, 결과를 문서로 드립니다.',
