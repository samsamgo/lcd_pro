...
const PRODUCTS: Product[] = [
  {
    ...
    pitch: 'P1.8 – P2.5',
    title: '가까이서 읽는 화면',
    body: '민원 창구, 로비, 회의실처럼 2~3m 앞에서 보는 자리입니다. 표와 작은 글씨가 뭉치지 않아야 합니다.',
    dot: 5,
    specs: [
      { k: '권장 시청거리', v: '2 m 이상' },
      { k: '설치', v: '실내 벽부 · 매립' },
  ...
  },
  {
    ...
    pitch: 'P2.5 – P4',
    title: '강당 뒷줄까지 닿는 화면',
    body: '체육관, 강당, 대회의실처럼 앞뒤 거리 차가 큰 공간입니다. 크기를 키우되 화소 간격은 거리에 맞춥니다.',
    dot: 7,
    specs: [
      { k: '권장 시청거리', v: '3 m 이상' },
      { k: '설치', v: '무대 배면 · 천장 행잉' },
  ...
  },
  {
    ...
    body: '정문 전자현수막, 진입로 안내판입니다. 직사광선과 빗물을 동시에 견뎌야 하므로 캐비닛 규격이 달라집니다.',
    dot: 9,
    specs: [
      { k: '권장 시청거리', v: '5 m 이상' },
      { k: '설치', v: '옥외 벽부 · 독립 지주' },
  ...
  },
  {
    ...
    pitch: 'P6 – P10',
    title: '멀리서 보는 화면',
    body: '광장, 도로변처럼 시청 거리가 10m를 넘는 자리입니다. 화소 간격을 넓혀 면적당 비용과 전력을 함께 잡습니다.',
    dot: 12,
    specs: [
      { k: '권장 시청거리', v: '10 m 이상' },
      { k: '설치', v: '구조물 취부 · 지주' },
