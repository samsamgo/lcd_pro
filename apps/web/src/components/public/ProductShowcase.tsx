...
const PRODUCTS: Product[] = [
  {
    ...
    pitch: 'P1.8 – P2.5',
    title: '가까이서 읽는 화면',
    body: '민원 창구, 로비, 회의실처럼 2~3m 앞에서 보는 자리입니다. 표와 작은 글씨가 뭉치면 안 됩니다.',
    dot: 5,
    specs: [
      { k: '권장 시청거리', v: '2 m 이상' },
      { k: '설치', v: '실내 벽부 · 매립' },
  ...
  },
  {
    ...
    pitch: 'P2.5 – P4',
    title: '강당 뒷줄까지 닿는 화면',
    body: '체육관, 강당처럼 앞뒤 거리 차가 큰 공간입니다. 화면은 키우되 화소 간격은 거리에 맞춥니다.',
    dot: 7,
    specs: [
      { k: '권장 시청거리', v: '3 m 이상' },
      { k: '설치', v: '무대 배면 · 천장 행잉' },
  ...
  },
  {
    ...
    body: '정문 전자현수막, 진입로 안내판입니다. 햇빛과 빗물을 같이 견뎌야 합니다.',
    dot: 9,
    specs: [
      { k: '권장 시청거리', v: '5 m 이상' },
      { k: '설치', v: '옥외 벽부 · 독립 지주' },
  ...
  },
  {
    ...
    pitch: 'P6 – P10',
    title: '멀리서 보는 화면',
    body: '광장, 도로변처럼 10m 넘게 떨어져 보는 자리입니다. 화소를 넓히면 비용과 전력이 함께 내려갑니다.',
    dot: 12,
    specs: [
      { k: '권장 시청거리', v: '10 m 이상' },
      { k: '설치', v: '구조물 취부 · 지주' },
