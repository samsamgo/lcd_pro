...
export const metadata: Metadata = {
  ...
  description:
    '우강테크(WK Tech)는 LED 전광판과 전자현수막을 설계·제작·시공합니다. 실측부터 A/S까지 하청 없이 직접 합니다.',
  applicationName: SITE.nameKo,
  authors: [{ name: SITE.nameKo }],
  generator: 'Next.js',
  // 🔴 2026-09-07 CEO 지시 — "우리 사이니지 업체라고. 왜 이렇게 관공서하고 학교에 집착해."
  // 정체성 단어인 'LED 사이니지' 가 정작 빠져 있었고, 고객군은 공공 셋뿐이었다.
  // 정체성 단어를 앞에 세우고 고객군을 실제 취급 범위대로 넓힌다(관공서·학교는 그중 둘로 유지).
  keywords: [
    'LED 사이니지', 'LED 전광판', '디지털 사이니지', '전자현수막', '우강테크', 'WK Tech',
    '전광판 설치', '전광판 견적', '전광판 제작', '전광판 AS',
    '관공서 전광판', '학교 전광판', '병원 전광판', '아파트 전광판', '주차장 전광판',
    '지자체 전자현수막', '조달 전광판',
  ],
  alternates: {
    canonical: '/',
  ...
  openGraph: {
    ...
    type: 'website',
    images: [
      { url: '/opengraph-image?v=20260910', width: 1200, height: 630, alt: `${SITE.nameKo} ${SITE.nameEn}` },
    ],
  },
  twitter: {
    ...
    description: SITE.taglineKo,
    images: ['/opengraph-image?v=20260910'],
  },
  robots: {
    index: true,
    follow: true,
