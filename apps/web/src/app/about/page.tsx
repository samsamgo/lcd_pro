...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <section className="space-y-6 text-base leading-[1.8] text-zinc-300">
        <p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong className="text-white">표준화된 시공</strong> — 동네 간판집의
            비표준성과 대형 SI의 느린 일정 사이의 빈 자리.
          </li>
          <li>
            <strong className="text-white">NovaStar Taurus 단일 표준</strong> —
            TB30(보급)·TB50(표준)·TB60(프리미엄) 3-tier 라인업.
            한 가지 운영 도구(VNNOX/ViPlex)로 모든 고객을 관리.
          </li>
          <li>
            <strong className="text-white">사진 3장 → 30분 견적</strong> — 현장
            실측 전 의미 있는 범위 가격을 받아볼 수 있도록 절차를 압축.
          </li>
          <li>
            <strong className="text-white">CMS 구독 + 원격 운영</strong> —
        ...
        <p>
          확정 가격이 아닌 <strong className="text-white">예상 범위</strong>로
          정직하게 시작합니다. 현장 실측 후 확정 견적을 별도로 드립니다.
          광고성 표현보다 <strong className="text-white">검증 가능한 사실</strong>로
          소통합니다.
        </p>
